...
struct ResultsView: View {
            ...
            if hasData {
                ...
                ScrollView {
                    VStack {
                        ...
                        Text("Below is the community's accuracy data, the orange lines are the community's mistaps and the other lines are the x, y, and z accelerations")
                            .font(.headline)
    ...
    func getItems() {
        ...
        db.collection("interactions").whereField("keysMistyped", arrayContains: 0.5)
            .limit(to: 20).getDocuments { (documents, error) in
